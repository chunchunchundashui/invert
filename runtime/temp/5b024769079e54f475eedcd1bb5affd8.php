<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\phpStudy\WWW\invest\public/../application/admin\view\main\lst.html";i:1577692934;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\head.html";i:1588388460;s:60:"D:\phpStudy\WWW\invest\application\admin\view\public\js.html";i:1580893892;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\left.html";i:1589337931;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>调查系统</title>
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <a href="<?php echo url('main/add'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>&nbsp;Add</a>
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url('main/edit', array('id' => $vo['id'])); ?>" id="mainEdit" class="btn btn-primary btn-sm shiny">
...
<script>
    ...
    function dele(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
            $.post("<?php echo url('main/del'); ?>",{id:id},function (data) {
