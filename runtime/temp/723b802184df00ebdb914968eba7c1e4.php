<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\phpStudy\WWW\invest\public/../application/admin\view\time\index.html";i:1584856684;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\head.html";i:1588388460;s:60:"D:\phpStudy\WWW\invest\application\admin\view\public\js.html";i:1580893892;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\left.html";i:1589337931;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>部门显示</title>
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($time) || $time instanceof \think\Collection || $time instanceof \think\Paginator): $i = 0; $__LIST__ = $time;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                   <tr>
                                       <td style="width: 1200px;" align="center"><?php echo $vo['time']; ?></td>
                                        <td align="center">
                                            <a href="<?php echo url('admin/achievement/teacher',array('time'=>$vo['time'],'personnel_id'=>$personnel_id)); ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 属性
                                            </a>
                                            <a href="javascript:void(0)" class="btn btn-danger brand_del btn-sm shiny" dataid="<?php echo $vo['time']; ?>+<?php echo $personnel_id; ?>">删除</a>
                                        </td>
                                  </tr>
...
<script>
  $('.brand_del').click(function () {
    ...
    $.ajax({
      url:"<?php echo url('admin/time/timedel'); ?>",
      type:'post',
