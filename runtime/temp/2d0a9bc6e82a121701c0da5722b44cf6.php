<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpStudy\WWW\invest\public/../application/admin\view\position\lst.html";i:1588841234;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\head.html";i:1588388460;s:60:"D:\phpStudy\WWW\invest\application\admin\view\public\js.html";i:1580893892;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\left.html";i:1589337931;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>调查系统</title>
            ...
            <div class="page-body">
                <form id="form1" class="navbar-form navbar-right" method="get">
                    <div class="form-group">
                        <input type="text" class="form-control input-sm" id="search" name="pname" placeholder="搜索" style="margin-left: 572px;display: inline-block"/>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-default btn-sm">搜索</button>
                    </div>
                </form>
                <a href="<?php echo url('position/add'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>&nbsp;Add</a>
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url('Position/edit', array('id' => $vo['id'])); ?>" id="mainEdit" class="btn btn-primary btn-sm shiny">
