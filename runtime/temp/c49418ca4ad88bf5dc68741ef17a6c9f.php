<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\phpStudy\WWW\invest\public/../application/admin\view\personnel\lst.html";i:1588678956;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\head.html";i:1588388460;s:60:"D:\phpStudy\WWW\invest\application\admin\view\public\js.html";i:1580893892;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\left.html";i:1589337931;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    <title>调查系统</title>
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <a href="<?php echo url('Personnel/add'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>&nbsp;Add</a>
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url('Personnel/edit', array('id' => $vo['id'])); ?>" id="mainEdit" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="javascript:void(0)" class="btn btn-danger btn-sm shiny" onclick="dele(this,'<?php echo $vo['id']; ?>')">删除</a>
                                                <a href="javascript:void(0)" class="btn btn-danger btn-sm shiny" onclick="upload(this,'<?php echo $vo['id']; ?>')">上传题库</a>
                                            </td>
                                        </tr>
...
<script>
    ...
    function dele(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
            $.post("<?php echo url('personnel/del'); ?>",{id:id},function (data) {
    ...
    function upload(obj,id){
        layer.confirm('确认上传吗？',function(index){
            //发异步删除数据
            $.post("<?php echo url('personnel/upload'); ?>",{id:id},function (data) {
                if(data.code == 1){
                    //删除成功 删除元素
                    layer.msg(data.msg,{icon:1,time:1000});
                }else{
