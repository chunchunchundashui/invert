<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"D:\phpStudy\WWW\invest\public/../application/admin\view\time\sort.html";i:1588484444;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\head.html";i:1588388460;s:60:"D:\phpStudy\WWW\invest\application\admin\view\public\js.html";i:1580893892;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\left.html";i:1589337931;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>部门显示</title>
...
<script>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
              ...
              返回上一级</button>
            <a href="<?php echo url('Achievement/achieve'); ?>">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                   <tr>
                                        ...
                                        <td align="center"><?php echo $vo['local']; ?></td>
                                        <td align="center"><?php echo $vo['achievement']; ?></td>
                                        <td align="center"><?php echo $vo['browse']; ?></td>
                                        <td align="center"><?php echo date('Y-m-d',$vo['time']); ?></td>
                                        <td align="center">
                                            <!--pid为2就表示当前显示的为教师授课满意度调查-->
                                            <a href="<?php echo url('admin/achievement/sort',array('local_id'=>$vo['lid'],'personnel_id'=>$data['personnel_id'],'time'=>$data['time'])); ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 属性
                                            </a>
                                          <a href="javascript:void(0)" class="btn btn-danger brand_del btn-sm shiny" dataid="<?php echo $vo['tid']; ?>+<?php echo $data['time']; ?>+<?php echo $data['personnel_id']; ?>+<?php echo $vo['lid']; ?>">删除</a>
                                        </td>
                                  </tr>
