<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\phpStudy\WWW\invest\public/../application/admin\view\achievement\copic.html";i:1588483276;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\head.html";i:1588388460;s:60:"D:\phpStudy\WWW\invest\application\admin\view\public\js.html";i:1580893892;s:62:"D:\phpStudy\WWW\invest\application\admin\view\public\left.html";i:1589337931;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>部门显示</title>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                  <button type="button" id="back" class="btn btn-sm btn-primary" style=" margin-left: 8px">返回上一级</button>
                  <button type="button" id="back1" class="btn btn-sm btn-primary" style=" margin-left: 8px">返回首页</button>
                  <a href="<?php echo url('Achievement/expData'); ?>">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                   <tr>
                                        <td align="center"><?php echo $vo['lname']; ?></td>
                                        <td align="center"><?php echo $vo['tname']; ?></td>
                                        <td align="center"><?php echo $vo['topic']; ?></td>
                                        <td align="center"><?php echo $vo['Summation']; ?></td>
...
<script>
    $('.brand_del').click(function () {
        ...
        $.ajax({
            url:"<?php echo url('admin/teacher/del'); ?>",
            type:'post',
            data: {id:id},
            dataType:'json',
            success: function (data) {
